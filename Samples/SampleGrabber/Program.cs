 ...
 * The purpose of this program is to demonstrate how to use the CiscoSource filter
 * in a C# application.  SampleGrabber creates a DirectShow Graph using the CiscoFilter
 ...
 *  2. Video window - A video viewer from the source requested in the Ciscosource URL
 *  3. Windows user interface - Provides valuable information regarding the status of your machine and the Ciscosource url that is rendering
 * 
...
namespace SampleGrabber
{
    ...
    internal class Program
    {
        ...
        /// </summary>
        /// <param name="args">Cisco Source URL</param>
        [STAThread]
        private static void Main(string[] args)
        {
            ...
            try
            {
                ...
                {
                    LogError("No Ciscosource url specified");
                    return;
                }
                bool restart = true;
                while (restart)
