...
namespace SampleGrabber
{
    ...
    /// allowing only one Ciscosource url at a time.  Furthermore, it is
    ...
    public class ViewModel : INotifyPropertyChanged, IDisposable
    {
        ...
        /// </summary>
        /// <param name="url">Ciscosource url</param>
        ...
        /// <summary>
        /// The Cisco filter has been created
        /// </summary>
        public bool Filter
        {
            get { return _filter; }
        ...
        /// <summary>
        /// The Cisco API is properly installed
        /// </summary>
        public bool CiscoAPI
        {
            get { return _ciscoAPI; }
            set { _ciscoAPI = value; RaisePropertyChanged("CiscoAPI"); }
        }
        private bool _ciscoAPI;
        ...
        /// <summary>
        /// The Cisco logging is turned on
        /// </summary>
        ...
        /// grabber to render video from an Cisco camera.
        /// </summary>
        /// <param name="pGraph">The actual graph</param>
        /// <param name="srcFile1">The URL of the Cisco stream</param>
        private void BuildGraph(IGraphBuilder pGraph, string srcFile1)
        {
            ...
            //add Cisco Filter
            var pCiscoFilter2 = CreateSourceFilter(pGraph, srcFile1);
            Filter = true;
        ...
        /// <summary>
        /// Create our Cisco source filter and load the 
        /// Cisco source url
        /// </summary>
        ...
        {
            //var clsidCiscoFilter = new Guid("{B3F5D418-CDB1-441C-9D6D-2063D5538962}"); //CiscoSource.ax
            //var pCiscoFilter2 = (IBaseFilter)Activator.CreateInstance(Type.GetTypeFromCLSID(clsidCiscoFilter));
            //int hr = pGraph.AddFilter(pCiscoFilter2, "Cisco Filter");
            //CheckHr(hr, "Can't add Cisco Filter to graph");
            ////set source filename
            //var pCiscoFilter2Src = pCiscoFilter2 as IFileSourceFilter;
            //if (pCiscoFilter2Src == null)
            //    CheckHr(unchecked((int)0x80004002), "Can't get IFileSourceFilter");
            
            //if (pCiscoFilter2Src != null) 
            //    hr = pCiscoFilter2Src.Load(url, null);
            
            //CheckHr(hr, "Can't load file");
            //Filter = true;
            IBaseFilter pCiscoFilter2;

            int hr = pGraph.AddSourceFilter(url, "SourceFilter", out pCiscoFilter2);
            CheckHr(hr, "Can't add source Filter to graph for url="+url);
            return pCiscoFilter2;
        }
        ...
        private void GetDefaultSettings()
        {
            try
            {
                using (var key = Registry.CurrentUser.OpenSubKey("Software\\Microsoft\\MediaPlayer\\Player\\Schemes\\CiscoSource"))
                {
                    if (key != null)
                    {
